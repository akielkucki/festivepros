...
export default function Home() {
    ...
    function setRotatedProducts(startIndex, count) {
        ...
        for (let i = 0; i < count; i++) {
            const safeIndex = (startIndex + i) % holidayProducts.length;
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            startIndex.current = (startIndex.current + 3) % holidayProducts.length;
            setRotatedProducts(startIndex.current, 3);
        }, 7000);
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="py-16 max-w-6xl mx-auto px-4">
                ...
                <div className="relative bg-white p-8 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="200">
                    <button onClick={prevTestimonial} className="absolute left-4 top-1/2 -translate-y-1/2">
                    ...
                    <button onClick={nextTestimonial} className="absolute right-4 top-1/2 -translate-y-1/2">
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <form className="space-y-4" data-aos="fade-left">
                            ...
                            <textarea placeholder="Your Message" rows="4" className="w-full p-3 rounded text-gray-800"></textarea>
